(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["wpo365-fxlib"] = factory();
	else
		root["wpo365-fxlib"] = factory();
})(window, function() {
...
var AppLauncher = /** @class */ (function () {
    ...
    AppLauncher.getReactDomConfig = function () {
        var allScripts = document.getElementsByTagName('script');
        var currScript = allScripts[allScripts.length - 1];
        var root = document.createElement('div');
        var rootId = Math.random()
            .toString(36)
            .replace(/[^a-z]+/g, '')
            .substr(0, 5);
...
var TokenCache = /** @class */ (function () {
    function TokenCache() {
        var tokenCache = localStorage.getItem('wpo365TokenCache');
        if (tokenCache) {
     ...
     */
    TokenCache.getToken = function (request, options) {
        return new es6_promise_1.Promise(function (resolve, reject) {
            if (TokenCache.instance == null) {
                TokenCache.instance = new TokenCache();
            }
            for (var _i = 0, _a = TokenCache.tokens; _i < _a.length; _i++) {
                var token = _a[_i];
            ...
            axios_1.default.post(options.wpAjaxAdminUrl, data)
                ...
                if (response.status == 200) {
                    if (response.data.status == 'OK') {
                        ...
                        for (var i = TokenCache.tokens.length - 1; i >= 0; i--) {
                            if (TokenCache.tokens[i].name == request.name) {
                                TokenCache.tokens.splice(i, 1);
                            }
                        }
                        TokenCache.tokens.push(token);
                        localStorage.setItem('wpo365TokenCache', JSON.stringify(TokenCache.tokens));
                        resolve(token);
                    }
                    else {
                        var responseError = new TokenRequestError();
                    ...
                    var error = new TokenRequestError();
                    error.data = {
                        status: 'NOK',
                        error_codes: '-1',
...
var TokenRequest = /** @class */ (function () {
    function TokenRequest(name, resourceId) {
        this.name = name;
...
Object.defineProperty(exports, "__esModule", { value: true });
var TokenCache_1 = __webpack_require__(/*! ./TokenCache */ "./src/lib/TokenCache.ts");
exports.TokenCache = TokenCache_1.TokenCache;
exports.TokenRequest = TokenCache_1.TokenRequest;
exports.TokenRequestError = TokenCache_1.TokenRequestError;
var FxAppLauncher_1 = __webpack_require__(/*! ./FxAppLauncher */ "./src/lib/FxAppLauncher.ts");
exports.AppLauncher = FxAppLauncher_1.AppLauncher;
...
/***/ 0:
/*!********************************!*\
  !*** multi ./src/lib/index.ts ***!
  \********************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! ./src/lib/index.ts */"./src/lib/index.ts");
